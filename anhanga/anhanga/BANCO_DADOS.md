...
| **user_type** | INTEGER | Tipo: 0=normal, 1=admin | DEFAULT 0 |
...
Reportes feitos pelos usuários.
...
| **username** | VARCHAR(50) | Username (denormalizado) | NOT NULL |
...
**Índices**: `idx_reports_location` (lat, lon), `idx_reports_nivel`, `idx_reports_created`

---

### 4. report_votes (futuro)
...
### Inserir Usuário
```sql
INSERT INTO users (username, name, password_hash, email, user_type)
VALUES ('joao.silva', 'João Silva', 'senha123', 'joao@email.com', 0);
```
